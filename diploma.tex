...
%==============================================================
\input{tex/00_terms}
\input{tex/01_abbreviations}
\input{tex/02_introduction}
\input{tex/03_bgp_domain}
\input{tex/04_bgp_dynamics}
\input{tex/05_storage_choice}
\input{tex/06_problem_statement}
\input{tex/07_architecture}
\input{tex/08_snapshot_stream}
\input{tex/09_art_storage}
\input{tex/10_experiment_methodology}
\input{tex/11_experiment_results}
\input{tex/12_limitations}
\input{tex/13_conclusion}
\bibliographystyle{ugost2008ls}
\bibliography{literature_25}

%==============================================================
\input{tex/14_illustrative_materials}
\input{tex/appendix_a_lpm_structures}
\input{tex/appendix_b_methodology}
\input{tex/appendix_c_api_reliability}
\input{tex/appendix_d_integration}
\end{document}
