...
В рамках работы был разработан микросервис, который поддерживает таблицу
соответствия IP-префиксов автономным системам по данным BGP и
предоставляет единый gRPC API для нескольких внутренних потребителей.
