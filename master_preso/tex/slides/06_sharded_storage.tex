\begin{frame}[fragile]\frametitle{Шардированное хранилище: устройство}
\centering
\begin{tikzpicture}[
  scale=0.88,
  transform shape,
...
\begin{itemize}\setlength{\itemsep}{0.05em}
  \item Ключ записи: адрес сети + длина префикса; FNV-хеш выбирает шард.
  \item Потоковые \texttt{Upsert}/\texttt{Delete} меняют только выбранный шард.
  \item \texttt{Lookup} проверяет активные длины префиксов и ищет кандидат в ART.
\end{itemize}
\end{frame}
